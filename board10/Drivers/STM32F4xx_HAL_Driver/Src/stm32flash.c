...
//  *
//  * @retval FLASH Status: The returned value can be: HALFLASH_BUSY, HALFLASH_ERROR_PROGRAM,
//  *                       HALFLASH_ERROR_WRP, FLASH_ERROR_OPERATION or HALFLASH_COMPLETE.
//  */
//FLASH_Status FLASH_EraseSector(uint32_t FLASH_Sector, uint8_t VoltageRange)
//{
//  uint32_t tmp_psize = 0x0;
//  FLASH_Status status = HALFLASH_COMPLETE;
//
//  /* Check the parameters */
...
//{
//  FLASH_Status flashstatus = HALFLASH_COMPLETE;
//
//  if((FLASH->SR & FLASH_FLAG_BSY) == FLASH_FLAG_BSY)
//  {
//    flashstatus = HALFLASH_BUSY;
//  }
//  else
//  {
//    if((FLASH->SR & FLASH_FLAG_WRPERR) != (uint32_t)0x00)
//    {
//      flashstatus = HALFLASH_ERROR_WRP;
//    }
//    else
//    {
//      if((FLASH->SR & (uint32_t)0xEF) != (uint32_t)0x00)
//      {
//        flashstatus = HALFLASH_ERROR_PROGRAM;
//      }
//      else
//      {
...
////{
////  __IO FLASH_Status status = HALFLASH_COMPLETE;
////
